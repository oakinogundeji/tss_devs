...
io.on('connection', function (socket) {
  ...
  socket.on('newPostCreated', function (email, postTitle) {
          ...
          controlFlow.each(user.friends, function (friend, cb) {
            ...
            exec(function (err, user) {
              ...
              var
                ...
                msg = '<p>'+ sender +' created a new post with title ' + postTitle + '</p>';
              if(friendSocket) {
      ...
      controlFlow.each(user.friends, function (friend, cb) {
        ...
        exec(function (err, user) {
          ...
          var
            friendID = user._id,
            friendSocket = userSockets[friendID],
            msg = '<p>'+ sender +' has changed status</p>';
          if(friendSocket) {
      ...
      controlFlow.each(user.friends, function (friend, cb) {
        ...
        exec(function (err, user) {
          ...
          var
            friendID = user._id,
            friendSocket = userSockets[friendID],
            msg = '<p>'+ sender +' has added ' + newFriend +' as a new friend</p>';
          if(friendSocket) {
      ...
      controlFlow.each(list, function (friend, cb) {
        ...
        exec(function (err, user) {
          ...
          var
            friendID = user._id,
            friendSocket = userSockets[friendID],
            msg = '<p>'+ sender +' has tagged you in a post titled ' + postTitle +'</p>';
  ...
  //on 'like post'
  socket.on('likedPost', function (title) {
    UserModel.findOne({_id: ID}, function (err, user) {
      if(err) {
        console.error(err);
        throw(err);
      ...
      controlFlow.each(user.friends, function (friend, cb) {
        ...
        exec(function (err, user) {
          ...
          var
            friendID = user._id,
            friendSocket = userSockets[friendID],
            msg = '<p>'+ sender +' liked a post with title ' + title +'</p>';
          if(friendSocket) {
  ...
  socket.on('madeComment', function (title) {
    UserModel.findOne({_id: ID}, function (err, user) {
      if(err) {
        console.error(err);
        throw(err);
      ...
      controlFlow.each(user.friends, function (friend, cb) {
        ...
        exec(function (err, user) {
          ...
          var
            friendID = user._id,
            friendSocket = userSockets[friendID],
            msg = '<p>'+ sender +' commented on a post with title ' + title +'</p>';
          if(friendSocket) {
  ...
  //on liked comment
  socket.on('likedComment', function (author) {
    UserModel.findOne({_id: ID}, function (err, user) {
      if(err) {
        console.error(err);
        throw(err);
      ...
      controlFlow.each(user.friends, function (friend, cb) {
        ...
        exec(function (err, user) {
          ...
          var
            friendID = user._id,
            friendSocket = userSockets[friendID],
            msg = '<p>'+ sender +' liked a comment by ' + author +'</p>';
          if(friendSocket) {
